  ...
  try {
    ...
    const call = await prisma.call.create({
      data: {
        ...
        formacionPrevia: data.formacionPrevia || null,
        pais: data.pais || null,
        edad: data.edad || null,
        estudiosPrevios: data.estudiosPrevios || null,
        motivacion: data.motivacion || null,
        canal: data.canal || null,
        razonNoInteres: data.razonNoInteres || null,
        palanca: data.palanca || null,
        status: "PENDING",
        userId: userId || null,
      },
    });
      ...
      const response = await fetch(endpoint, {
        ...
        body: JSON.stringify({
          ...
          metadata: {
            ...
            formacionPrevia: data.formacionPrevia,
            pais: data.pais,
            edad: data.edad,
            estudiosPrevios: data.estudiosPrevios,
            motivacion: data.motivacion,
            canal: data.canal,
            razonNoInteres: data.razonNoInteres,
